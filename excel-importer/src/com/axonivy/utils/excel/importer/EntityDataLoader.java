...
public class EntityDataLoader {
  ...
  try {
    Class<?> entityClass = Class.forName(entity.getName());
    manager.findAll(entityClass);
      return entityClass;
    } catch (ClassNotFoundException e) {
      throw new RuntimeException(
        "Entity class not found. Ensure the Data Class is generated by Designer: " + entity.getName(),
        e
      );
    }
  }
